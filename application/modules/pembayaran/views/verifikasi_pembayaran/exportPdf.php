					...
					<div class="col-xs-12 head" style="display: inline-block; text-align: left;">
						<table class="col-xs-12">
							<tbody>
								<tr>
									<td colspan="2">
										<label class="col-xs-12" style="font-size: 18pt; display: inline-block; margin-bottom: 10px; text-decoration: underline"><b>BUKTI BANK KELUAR</b></label>
									</td>
								</tr>
								<tr>
									...
									<td class="col-xs-6" style="vertical-align: top; font-size: 10pt;">
										<div class="col-xs-12" style="display: inline; text-align: left;">
											...
											<label style="display: inline-block; width: 75.5%;"><?php echo strtoupper($data['kode_trans']); ?></label>
										</div>
										<div class="col-xs-12" style="display: inline; text-align: left;">
							...
							<thead>
								<tr>
									<td colspan="3">
										...
										<label style="display: inline-block; width: 50%; text-align: left;">
											<label class="col-xs-12" style="display: inline-block;">No. Giro : <?php echo isset($data['no_giro']) ? $data['no_giro'] : ''; ?></label>
										</label>
									</td>
								</tr>
								<tr>
								...
								<?php for ($j=1; $j <= $jml_data; $j++) { ?>
									...
									<?php if ( $idx == 0 ) { ?>
										<tr>
											...
											<td align="left">
												<?php
													$ket = $data['ket_realisasi'];
													echo $ket; 
												?>
												<?php // echo strtoupper($detail[ $idx ]['keterangan']); ?>
											</td>
											<td align="right"><?php echo angkaDecimal($data['jml_transfer']); ?></td>
										</tr>
										<?php 
											$total += $data['jml_transfer']; 
										?>
									<?php } else { ?>
										<?php
											$_class = "no-border";
