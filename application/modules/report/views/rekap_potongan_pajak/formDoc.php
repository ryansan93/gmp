<div class="col-xs-12 no-padding">
    ...
    <div class="col-xs-12 no-padding">
        <button type="button" class="col-xs-12 btn btn-primary pull-right" onclick="rpp.getLists(this)" data-jenis="3"><i class="fa fa-search"></i> Tampilkan</button>
    </div>
                ...
                <table class="table table-bordered tbl_laporan" style="max-width: 150%; width: 150%; margin-bottom: 0px;">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th style="width: 5%;">NO. SUPPLIER</th>
    ...
    <div class="col-xs-12 no-padding"><hr style="margin-top: 10px; margin-bottom: 10px;"></div>
    <div class="col-xs-12 no-padding">
        <button type="button" class="btn btn-default pull-right" onclick="rpp.excryptParams(this)" data-jenis="3"><i class="fa fa-file-excel-o"></i> Export Excel</button>
    </div>
</div>
