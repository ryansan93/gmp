	...
	<div class="col-xs-12">
		<div class="col-xs-12 no-padding">
			<div class="col-sm-12 no-padding">
				<label>RINGKASAN GL PER UNIT</label>
			</div>
			<div class="col-sm-12 no-padding">
			...
			<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
				<button type="button" class="col-xs-12 btn btn-primary pull-right" onclick="rgu.getData()"><i class="fa fa-search"></i> Tampilkan</button>
			</div>
		</div>
	</div>
			...
			<table class="table table-bordered tbl_laporan" width="100%" cellspacing="0" style="margin-bottom: 0px;">
				<thead>
					<tr class="abu">
						...
						<td class="col-xs-3"><b>Nama Unit</b></td>
						<td class="col-xs-2 text-right"><b>Saldo Awal</b></td>
						<td class="col-xs-2 text-right"><b>Debet</b></td>
						<td class="col-xs-2 text-right"><b>Kredit</b></td>
						<td class="col-xs-2 text-right"><b>Saldo Akhir</b></td>
					</tr>
				</thead>
				<tbody>
					<tr>
