...
class KertasKerjaHpp extends Public_Controller {
    ...
    public function exportExcel($params_encrypt)
    {
        ...
        $arr_column[ $idx ] = array(
            ...
            'K' => array('value' => 'PAKAN', 'data_type' => 'string', 'colspan' => array('F','K'), 'align' => 'center', 'text_style' => 'bold'),
            'P' => array('value' => 'OVK', 'data_type' => 'string', 'colspan' => array('L','P'), 'align' => 'center', 'text_style' => 'bold'),
            'U' => array('value' => 'DOC', 'data_type' => 'string', 'colspan' => array('Q','U'), 'align' => 'center', 'text_style' => 'bold'),
            'Z' => array('value' => 'OA', 'data_type' => 'string', 'colspan' => array('V','Z'), 'align' => 'center', 'text_style' => 'bold'),
            'AA' => array('value' => 'RHPP', 'data_type' => 'string','rowspan' => array('AA3','AA4'), 'align' => 'center', 'text_style' => 'bold'),
            'AB' => array('value' => 'TOTAL', 'data_type' => 'string','rowspan' => array('AB3','AB4'), 'align' => 'center', 'text_style' => 'bold'),
        );
        $idx++;
        $arr_column[ $idx ] = array(
            ...
            'K' => array('value' => 'SISA', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'L' => array('value' => 'BELI', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'M' => array('value' => 'MUTASI (+)', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'N' => array('value' => 'MUTASI (-)', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'O' => array('value' => 'KOREKSI (+/-)', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'P' => array('value' => 'PEMAKAIAN', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'Q' => array('value' => 'BELI', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'R' => array('value' => 'MUTASI (+)', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'S' => array('value' => 'MUTASI (-)', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'T' => array('value' => 'KOREKSI (+/-)', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'U' => array('value' => 'PEMAKAIAN', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'V' => array('value' => 'BELI', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'W' => array('value' => 'MUTASI (+)', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'X' => array('value' => 'MUTASI (-)', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'Y' => array('value' => 'KOREKSI (+/-)', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
            'Z' => array('value' => 'NET OA', 'data_type' => 'string', 'align' => 'center', 'text_style' => 'bold'),
        );
        $idx++;
        ...
        if ( !empty($data) ) {
            foreach ($data as $key => $value) {
                $arr_column[ $idx ] = array(
                    ...
                    'K' => array('value' => ($value['sisa_pkn']), 'data_type' => 'decimal2'),
                    'L' => array('value' => ($value['beli_ovk']), 'data_type' => 'decimal2'),
                    'M' => array('value' => ($value['mutasi_msk_ovk']), 'data_type' => 'decimal2'),
                    'N' => array('value' => ($value['mutasi_klwr_ovk']), 'data_type' => 'decimal2'),
                    'O' => array('value' => (0), 'data_type' => 'decimal2'),
                    'P' => array('value' => ($value['pemakaian_ovk']), 'data_type' => 'decimal2'),
                    'Q' => array('value' => ($value['beli_doc']), 'data_type' => 'decimal2'),
                    'R' => array('value' => ($value['mutasi_msk_doc']), 'data_type' => 'decimal2'),
                    'S' => array('value' => ($value['mutasi_klwr_doc']), 'data_type' => 'decimal2'),
                    'T' => array('value' => ($value['koreksi_doc']), 'data_type' => 'decimal2'),
                    'U' => array('value' => ($value['pemakaian_doc']), 'data_type' => 'decimal2'),
                    'V' => array('value' => ($value['beli_oa']), 'data_type' => 'decimal2'),
                    'W' => array('value' => ($value['mutasi_msk_oa']), 'data_type' => 'decimal2'),
                    'X' => array('value' => ($value['mutasi_klwr_oa']), 'data_type' => 'decimal2'),
                    'Y' => array('value' => (0), 'data_type' => 'decimal2'),
                    'Z' => array('value' => ($value['pemakaian_oa']), 'data_type' => 'decimal2'),
                    'AA' => array('value' => ($value['pdpt_peternak']), 'data_type' => 'decimal2'),
                    'AB' => array('value' => ($value['total']), 'data_type' => 'decimal2'),
                );
