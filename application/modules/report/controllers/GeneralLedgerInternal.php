...
class GeneralLedgerInternal extends Public_Controller {
    ...
    */
            ...
            from (
                ...
                (
                    ...
                    where 
                        ...
                        (sb.noreg is not null and j.kode = 'MI')
                ) sa
                group by
                    sa.noreg,
                    sa.no_coa,
            ...
            (
                ...
                left join
                    (
                        ...
                        group by
                            noreg, tanggal, cast(keterangan as varchar(max)), kode_trans, no_coa, unit, kredit, debet
                    ) dj
                    on
                        dj.no_coa = c.coa
                where
    ...
    public function formDetail()
    {
        ...
        $nama_mitra = '';
        if ( $d_conf->count() > 0 ) {
            $nama_mitra = $d_conf->toArray()[0]['nama_mitra'];
        }
