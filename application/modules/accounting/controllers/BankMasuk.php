        ...
        try {
            ...
            foreach ($params['detail'] as $k_det => $v_det) {
                ...
                */
                ...
                $m_djurnal->asal = $v_det['coa_asal_nama'];
                $m_djurnal->coa_asal = $v_det['coa_asal'];
                $m_djurnal->tujuan = null;
                $m_djurnal->coa_tujuan = null;
                $m_djurnal->unit = $params['unit'];
                $m_djurnal->tbl_name = $m_km->getTable();
                $m_djurnal->tbl_id = $no_km;
                $m_djurnal->invoice = $v_det['no_invoice'];
            ...
            $m_djurnal_header->tanggal = $params['tgl_km'];
            ...
            $m_djurnal_header->asal = null;
            $m_djurnal_header->coa_asal = null;
            $m_djurnal_header->tujuan = $params['nama_bank'];
            $m_djurnal_header->coa_tujuan = $params['coa_bank'];
            $m_djurnal_header->unit = $params['unit'];
            $m_djurnal_header->tbl_name = $m_km->getTable();
            $m_djurnal_header->tbl_id = $no_km;
            $m_djurnal_header->invoice = null;
            $m_djurnal_header->kode_trans = $no_km;
            $m_djurnal_header->kode_jurnal = $no_km;
            $m_djurnal_header->pelanggan = $params['no_pelanggan'];
