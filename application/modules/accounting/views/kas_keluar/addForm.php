<div class="col-xs-7 no-padding" style="padding-right: 5px;">
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		...
		<div class="col-xs-4 no-padding">
			<input type="text" class="col-xs-12 form-control no_kk uppercase" placeholder="No. Kas Keluar" disabled>
		</div>
	</div>
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
	...
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		...
		<div class="col-xs-7 no-padding">
			<input type="text" class="col-xs-12 form-control supplier uppercase" placeholder="Nama Tujuan (MAX:100)" maxlength="100" data-required="1">
		</div>
	</div>
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
