<div class="col-xs-7 no-padding" style="padding-right: 5px;">
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		...
		<div class="col-xs-4 no-padding">
			<input type="text" class="col-xs-12 form-control no_kk uppercase" placeholder="No. Bank Keluar" value="<?php echo $data['no_kk']; ?>" disabled>
		</div>
	</div>
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
	...
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		<div class="col-xs-3 no-padding"><label class="control-label">No. Tujuan</label></div>
	...
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		<div class="col-xs-3 no-padding"><label class="control-label">Nama Tujuan</label></div>
		<div class="col-xs-7 no-padding">
			<input type="text" class="col-xs-12 form-control supplier uppercase" placeholder="Nama Tujuan (MAX:100)" maxlength="100" data-required="1" value="<?php echo $data['supplier']; ?>">
		</div>
	</div>
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
					...
					<?php if ( !empty($detail) ) { ?>
						<?php foreach ($detail as $k_det => $v_det) { ?>
							<tr class="data" data-urut="<?php echo $v_det['no_urut']; ?>">
								...
								<td>
									<input type="text" class="form-control text-right nilai uppercase" placeholder="Nilai" data-tipe="decimal" maxlength="19" data-required="1" onblur="bk.hitGrandTotal(this)" value="<?php echo angkaDecimal($v_det['nilai']); ?>">
								</td>
								<td>
									<div class="col-xs-12 no-padding">
...
<div class="col-xs-12 no-padding">
    <button type="button" class="btn btn-primary pull-right" onclick="bk.edit(this)" data-kode="<?php echo $data['no_kk']; ?>" style="margin-left: 5px;">
        <i class="fa fa-save"></i>
        Update
    </button>
    <button type="button" class="btn btn-danger pull-right" onclick="bk.changeTabActive(this)" data-href="action" data-edit="" data-kode="<?php echo $data['no_kk']; ?>" style="margin-right: 5px;">
