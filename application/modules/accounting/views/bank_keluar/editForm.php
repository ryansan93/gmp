						...
						<?php foreach ($detail as $k_det => $v_det) { ?>
							<tr class="data" data-urut="<?php echo $v_det['no_urut']; ?>">
								...
								<!-- <td style="width: 10%; max-width: 10%;">
									<input type="text" class="form-control text-right nilai_lpb uppercase" placeholder="Nilai Invoice" data-tipe="decimal" maxlength="19" value="<?php echo angkaDecimal($v_det['nilai_lpb']); ?>" disabled>
								</td> -->
