...
<div class="col-xs-12 no-padding">
	...
	<div class="col-xs-6 no-padding div_tutup_bulan" data-val="<?php echo substr($data['tgl_kk'], 0, 10); ?>">
		...
		<?php if ( $akses['a_delete'] == 1 ) { ?>
			<button type="button" class="btn btn-danger pull-right btn_tutup_bulan" onclick="bk.delete(this)" data-kode="<?php echo $data['no_kk']; ?>" style="margin-right: 5px;">
		...
		<?php if ( $akses['a_edit'] == 1 || $akses['a_delete'] == 1) { ?>
			...
			<button type="button" class="btn btn-default pull-right" onclick="bk.printPreview(this)" data-kode="<?php echo exEncrypt($data['no_kk']); ?>"><i class="fa fa-print"></i> Cetak</button>
			<!-- <button type="button" class="btn btn-default pull-right" onclick="bk.exportPdf(this)" data-kode="<?php echo exEncrypt($data['no_kk']); ?>"><i class="fa fa-print"></i> Cetak</button> -->
		<?php } ?>
	</div>
</div>