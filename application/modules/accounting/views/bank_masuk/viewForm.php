...
<div class="col-xs-12 no-padding">
	...
	<div class="col-xs-6 no-padding div_tutup_bulan" data-val="<?php echo substr($data['tgl_km'], 0, 10); ?>">
		<?php if ( $akses['a_edit'] == 1 ) { ?>
			<button type="button" class="btn btn-primary pull-right btn_tutup_bulan" onclick="bm.changeTabActive(this)" data-href="action" data-edit="edit" data-kode="<?php echo $data['no_km']; ?>" style="margin-left: 5px;">
				<i class="fa fa-edit"></i>
				Edit
			</button>
		<?php } ?>
		<?php if ( $akses['a_delete'] == 1 ) { ?>
			<button type="button" class="btn btn-danger pull-right btn_tutup_bulan" onclick="bm.delete(this)" data-kode="<?php echo $data['no_km']; ?>" style="margin-right: 5px;">
		...
		<?php if ( $akses['a_edit'] == 1 || $akses['a_delete'] == 1) { ?>
			...
			<button type="button" class="btn btn-default pull-right" onclick="bm.printPreview(this)" data-kode="<?php echo exEncrypt($data['no_km']); ?>"><i class="fa fa-print"></i> Cetak</button>
			<!-- <button type="button" class="btn btn-default pull-right" onclick="bm.exportPdf(this)" data-kode="<?php echo exEncrypt($data['no_km']); ?>"><i class="fa fa-print"></i> Cetak</button> -->
		<?php } ?>
	</div>
</div>