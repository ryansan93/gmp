<?php if ( $akses['a_submit'] == 1 ) { ?>
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		<button type="button" class="col-xs-12 btn btn-success pull-right" onclick="bm.changeTabActive(this)" data-href="action" data-edit=""><i class="fa fa-plus"></i> ADD</button>
	</div>
...
<div class="col-xs-12 no-padding">
	<button type="button" class="col-xs-12 btn btn-primary pull-right tampilkan_riwayat" onclick="bm.getLists(this)"><i class="fa fa-search"></i> Tampilkan</button>
</div>
		...
		<table class="table table-bordered tbl_riwayat">
			<thead>
				<tr>
					...
					<th class="col-xs-2">No. Bank Masuk</th>
