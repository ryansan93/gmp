<div class="col-xs-7 no-padding" style="padding-right: 5px;">
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		...
		<div class="col-xs-4 no-padding">
			<input type="text" class="col-xs-12 form-control no_km uppercase" placeholder="No. Kas Masuk" disabled>
		</div>
	</div>
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
	...
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		...
		<div class="col-xs-7 no-padding">
			<input type="text" class="col-xs-12 form-control pelanggan uppercase" placeholder="Nama Asal (MAX:100)" maxlength="100" data-required="1">
		</div>
	</div>
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
...
<div class="col-xs-12 no-padding">
	<button type="button" class="btn btn-primary pull-right" onclick="km.save()"><i class="fa fa-save"></i> Simpan</button>
</div>