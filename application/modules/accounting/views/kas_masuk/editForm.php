					...
					<?php if ( !empty($detail) ) { ?>
						<?php foreach ($detail as $k_det => $v_det) { ?>
							<tr class="data" data-urut="<?php echo $v_det['no_urut']; ?>">
								...
								<td style="width: 10%; max-width: 10%;">
									<input type="text" class="form-control text-right nilai uppercase" placeholder="Nilai" data-tipe="decimal" maxlength="19" data-required="1" onblur="km.hitGrandTotal(this)" value="<?php echo formatAngka($v_det['nilai']); ?>">
								</td>
								<td style="width: 10%; max-width: 10%;">
									<div class="col-xs-12 no-padding">
