...
<div class="col-xs-12 no-padding">
	...
	<div class="col-xs-1 no-padding text-center"><label class="control-label">:</label></div>
	<div class="col-xs-9 no-padding"><label class="control-label"><?php echo $data['nama_mitra']; ?></label></div>
</div>
<div class="col-xs-12 no-padding">
	<div class="col-xs-2 no-padding"><label class="control-label">Noreg</label></div>
	<div class="col-xs-1 no-padding text-center"><label class="control-label">:</label></div>
	<div class="col-xs-9 no-padding"><label class="control-label"><?php echo $data['noreg']; ?></label></div>
</div>
<div class="col-xs-12 no-padding">
...
<?php if ( $akses['a_delete'] == 1 ) { ?>
	...
	<div class="col-xs-12 no-padding">
		<button type="button" class="col-xs-12 btn btn-danger" onclick="aops.delete(this)" data-id="<?php echo $data['id']; ?>"><i class="fa fa-trash"></i> HAPUS</button>
	</div>
<?php } ?>
