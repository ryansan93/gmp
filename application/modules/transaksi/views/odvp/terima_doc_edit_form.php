		...
		<div class="col-lg-12 detailed">
			...
			<form role="form" class="form-horizontal">
				...
				<div class="form-group d-flex align-items-center">
					...
					<div class="col-lg-4">
						<div class="input-group date col-md-12 lock_date_fiskal" id="datetimepicker2" name="tgl_kirim_doc" data-tgl="<?php echo $data_terima_doc['kirim']; ?>">
				...
				<div class="form-group d-flex align-items-center">
					...
					<div class="col-lg-4">
						<div class="input-group date col-md-12 lock_date_fiskal" id="datetimepicker1" name="tgl_tiba_kdg" data-tgl="<?php echo $data_terima_doc['datang']; ?>">
