...
<div class="col-xs-12 no-padding" style="margin-bottom: 10px;">
	<div class="col-xs-3 no-padding">
		...
		<div class="col-xs-12 no-padding">
			<input type="text" class="form-control text-right nilai_cn" data-tipe="decimal" placeholder="Nilai CN" data-required="1" value="<?php echo angkaDecimal($data['sisa']); ?>" disabled>
		</div>
	</div>
</div>
<div class="col-xs-12 no-padding" style="margin-bottom: 10px;">
	<div class="col-xs-3 no-padding">
		...
		<div class="col-xs-12 no-padding">
			<input type="text" class="form-control text-right pakai_cn" data-tipe="decimal" placeholder="Total Pakai CN" data-required="1" value="<?php echo angkaDecimal($data['tot_pakai']); ?>" disabled>
		</div>
	</div>
</div>
					...
					<tr class="head">
						...
						<td>
							...
							<div class="col-xs-10 no-padding" style="padding-left: 5px;">
								<input type="text" class="col-xs-12 form-control pakai text-right" data-tipe="decimal" data-required="1" onblur="cn.hitTotalPakai()" value="<?php echo angkaDecimal($v_det['pakai']); ?>" >
							</div>
						</td>
						<td>
