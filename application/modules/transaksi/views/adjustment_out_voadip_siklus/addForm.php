...
<div class="col-xs-12 no-padding" style="margin-bottom: 10px;">
	<button type="button" class="btn btn-primary" onclick="aovs.getStokSiklus()"><i class="fa fa-search"></i> Cek Stok</button>
</div>
...
<div class="col-xs-12 no-padding"><hr style="margin-top: 10px; margin-bottom: 10px;"></div>
<div class="col-xs-12 no-padding">
	<button type="button" class="col-xs-12 btn btn-primary" onclick="aovs.save()"><i class="fa fa-save"></i> Simpan</button>
</div>
