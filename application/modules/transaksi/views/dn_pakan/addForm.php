...
<div class="col-xs-12 no-padding">
	<div class="col-xs-12 no-padding">
		...
		<div class="col-xs-10 no-padding"><label class="label-control asal">-</label></div>
	</div>
	<div class="col-xs-12 no-padding">
		<div class="col-xs-1 no-padding"><label class="label-control">Tujuan</label></div>
		<div class="col-xs-1 no-padding" style="max-width: 2%;"><label class="label-control">:</label></div>
		<div class="col-xs-10 no-padding"><label class="label-control tujuan">-</label></div>
	</div>
</div>
...
<div class="col-xs-12 no-padding" style="margin-bottom: 10px;">
	...
	<div class="col-xs-3 no-padding" style="padding-left: 5px;">
