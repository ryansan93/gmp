...
class DnPakan extends Public_Controller {

    private $path = 'transaksi/dn_pakan/';
    private $url;
    private $akses;
    ...
    public function index($segment=0)
    {
        if ( $this->akses['a_view'] == 1 ) {
            $this->add_external_js(array(
                ...
                "assets/transaksi/dn_pakan/js/dn-pakan.js",
            ));
            $this->add_external_css(array(
                "assets/select2/css/select2.min.css",
                "assets/transaksi/dn_pakan/css/dn-pakan.css",
            ));
            ...
            // Load Indexx
            $data['title_menu'] = 'Debit Note Pakan';
    ...
    public function save()
    {
        ...
        try {
            ...
            $nomor = $m_dn->getNextNomor('DN/PKN');
