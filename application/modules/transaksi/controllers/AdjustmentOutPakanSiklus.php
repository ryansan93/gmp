...
class AdjustmentOutPakanSiklus extends Public_Controller {

    private $path = 'transaksi/adjustment_out_pakan_siklus/';
    private $url;
    private $akses;
    ...
    public function index($segment=0)
    {
        if ( $this->akses['a_view'] == 1 ) {
            $this->add_external_js(array(
                ...
                "assets/transaksi/adjustment_out_pakan_siklus/js/adjustment-out-pakan-siklus.js",
            ));
            $this->add_external_css(array(
                "assets/select2/css/select2.min.css",
                "assets/transaksi/adjustment_out_pakan_siklus/css/adjustment-out-pakan-siklus.css",
            ));
            ...
            // Load Indexx
            $data['title_menu'] = 'Adjustment Out Pakan (Siklus)';
    ...
    public function getLists()
    {
        ...
        $sql = "
            ...
            from adjout_pakan_siklus adjout
            left join
                rdim_submit rs
                on
    ...
    public function save()
    {
        ...
        try {
            $m_adjout = new \Model\Storage\AdjoutPakanSiklus_model();
    ...
    public function execHitStokSiklus() {
        ...
        try {
            ...
            $sql = "EXEC hitung_stok_siklus 'pakan', 'adjout_pakan_siklus', '".$id."', '".$tanggal."', ".$status.", ".$noreg.", null";
