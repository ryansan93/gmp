...
class AdjustmentInPakanSiklus extends Public_Controller {

    private $path = 'transaksi/adjustment_in_pakan_siklus/';
    private $url;
    private $akses;
    ...
    public function index($segment=0)
    {
        if ( $this->akses['a_view'] == 1 ) {
            $this->add_external_js(array(
                ...
                "assets/transaksi/adjustment_in_pakan_siklus/js/adjustment-in-pakan-siklus.js",
            ));
            $this->add_external_css(array(
                "assets/select2/css/select2.min.css",
                "assets/transaksi/adjustment_in_pakan_siklus/css/adjustment-in-pakan-siklus.css",
            ));
            ...
            // Load Indexx
            $data['title_menu'] = 'Adjustment In Pakan (Siklus)';
    ...
    public function save()
    {
        ...
        try {
            $m_adjin = new \Model\Storage\AdjinPakanSiklus_model();
            $now = $m_adjin->getDate();
    ...
    public function execHitStokSiklus() {
        ...
        try {
            ...
            $sql = "EXEC hitung_stok_siklus 'pakan', 'adjin_pakan_siklus', '".$id."', '".$tanggal."', ".$status.", ".$noreg.", null";
