...
class AdjustmentInVoadipSiklus extends Public_Controller {

    private $path = 'transaksi/adjustment_in_voadip_siklus/';
    private $url;
    private $akses;
    ...
    public function index($segment=0)
    {
        if ( $this->akses['a_view'] == 1 ) {
            $this->add_external_js(array(
                ...
                "assets/transaksi/adjustment_in_voadip_siklus/js/adjustment-in-voadip-siklus.js",
            ));
            $this->add_external_css(array(
                "assets/select2/css/select2.min.css",
                "assets/transaksi/adjustment_in_voadip_siklus/css/adjustment-in-voadip-siklus.css",
            ));
            ...
            // Load Indexx
            $data['title_menu'] = 'Adjustment In OVK (Siklus)';
    ...
    public function getLists()
    {
        ...
        $sql = "
            ...
            from adjin_voadip_siklus adjin
            left join
                rdim_submit rs
                on
    ...
    public function save()
    {
        ...
        try {
            $m_adjin = new \Model\Storage\AdjinVoadipSiklus_model();
            $now = $m_adjin->getDate();
    ...
    public function execHitStokSiklus() {
        ...
        try {
            ...
            $sql = "EXEC hitung_stok_siklus 'voadip', 'adjin_voadip_siklus', '".$id."', '".$tanggal."', ".$status.", ".$noreg.", null";
