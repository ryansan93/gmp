...
class CnPakan extends Public_Controller {

    private $path = 'transaksi/cn_pakan/';
    private $url;
    private $akses;
    ...
    public function index($segment=0)
    {
        if ( $this->akses['a_view'] == 1 ) {
            $this->add_external_js(array(
                ...
                "assets/transaksi/cn_pakan/js/cn-pakan.js",
            ));
            $this->add_external_css(array(
                "assets/select2/css/select2.min.css",
                "assets/transaksi/cn_pakan/css/cn-pakan.css",
            ));
            ...
            // Load Indexx
            $data['title_menu'] = 'Credit Note Pakan';
    ...
    public function getData($id)
    {
        ...
        $sql = "
            ...
            left join
                ...
                on
                    c.det_jurnal_trans_kode = djt.kode
            left join
                jurnal_trans jt
                on
                    jt.id = djt.id_header
    ...
    public function save()
    {
        ...
        try {
            ...
            $nomor = $m_cn->getNextNomor('CN/PKN');
            ...
            $m_cn->det_jurnal_trans_kode = $params['det_jurnal_trans'];
            $m_cn->save();
