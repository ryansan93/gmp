	...
	<form class="form form-horizontal" role="form">
		<div name="data-mitra">
					...
					<select class="form-control badan_usaha_mitra" name="badan_usaha_mitra">
						...
						<?php if ( !empty($badan_usaha) ) { ?>
							<?php foreach ($badan_usaha as $key => $value) { ?>
								...
								<option value="<?php echo $value['id_badan_usaha']; ?>" data-singkatan="<?php echo $singkatan_bersih; ?>" data-terbuka="<?php echo $value['is_terbuka']; ?>" <?php echo ($mitra['badan_usaha'] == $value['id_badan_usaha']) ? 'selected' : ''; ?>><?php echo $value['nama_badan_usaha']; ?><?php echo (!empty($singkatan_bersih)) ? ' ('.$singkatan_bersih.($value['is_terbuka'] == 1 ? ' Tbk' : '').')' : ''; ?></option>
							<?php } ?>
						<?php } ?>
					</select>
				</div>
			...
			<div class="form-group align-items-center d-flex">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control nama_singkat_mitra" placeholder="Isi utk update Nama Plasma">
				</div>
			</div>
			<div class="form-group align-items-center d-flex">
				<span class="col-sm-2 text-right">Nama Plasma</span>
				<div class="col-sm-5">
					<input required="required" type="text" class="form-control nama_perusahaan_mitra" name="nama_mitra" placeholder="Nama Plasma" value="<?php echo $mitra['nama'] ?>" readonly>
				</div>
			</div>
			<div class="form-group align-items-center d-flex">
			...
			<div class="form-group align-items-center d-flex">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control ktp_input" name="ktp" placeholder="nomor ktp" required data-tipe="ktp" value="<?php echo $mitra['ktp'] ?>">
				</div>
			</div>
			<div class="form-group align-items-center d-flex">
				<span class="col-sm-2 text-right npwp_label">NPWP</span>
				<div class="col-sm-3">
					<input type="text" class="form-control npwp_input" name="npwp" placeholder="npwp" value="<?php echo $mitra['npwp'] ?>">
				</div>
			</div>
			<div class="form-group align-items-center d-flex">
				<span class="col-sm-2 text-right">Nama Coretax</span>
				<div class="col-sm-3">
					<input type="text" class="form-control" name="nama_coretax" placeholder="nama coretax" value="<?php echo $mitra['nama_coretax'] ?>">
				</div>
			</div>
			<div class="form-group align-items-center d-flex">
