			...
			<div id="jenis_pelanggan">
				<div class="col-sm-4">
					...
					<?php if ( $akses['a_ack'] == 1 ): ?>
						<div class="form-group align-items-center d-flex">
							...
							<div class="col-sm-6">
								<input class="form-control" type="text" name="nip_pelanggan" value="<?php echo $data->nomor; ?>" placeholder="MAX:6" maxlength="6" readonly>
							</div>
						</div>
					<?php endif; ?>
					<div class="form-group align-items-center d-flex">
				...
				<div class="col-sm-12">
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-4">
							<select class="form-control badan_usaha_plg" name="badan_usaha_plg">
					...
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-6">
							<input class="form-control nama_singkat_plg" type="text" placeholder="Isi utk update Nama Perusahaan">
						</div>
					</div>
					<div class="form-group align-items-center d-flex">
						<span class="col-sm-2 text-right">Nama Perusahaan</span>
						<div class="col-sm-8">
							<input required="required" class="form-control nama_perusahaan_plg" type="text" name="nama_plg" placeholder="Nama Perusahaan" value="<?php echo $data['nama']; ?>" readonly>
						</div>
					</div>
				</div>
				<div class="col-sm-12">
				...
				<div class="col-sm-12 no-padding">
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-2" style="margin-left: 11px; padding-right: 20px;">
							<input required="required" class="form-control ktp_input" type="text" name="ktp_plg" placeholder="Nomer KTP" value="<?php echo $data['nik']; ?>">
						</div>
			...
			<div id="alamat_usaha_pelanggan">
				...
				<div class="col-sm-12 no-padding">
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-2" style="margin-left: 11px; padding-right: 20px;">
							<input class="form-control npwp_input" type="text" name="npwp_plg" placeholder="Nomer NPWP" value="<?php echo $data['npwp']; ?>">
						</div>
						<div class="col-sm-8 no-padding">
							...
							<label class="col-sm-1" data-idnama="<?php echo $list_lampiran_usaha_pelanggan['id'] ?>">
								<input type="file" onchange="showNameFile(this)" class="file_lampiran pelanggan npwp_lampiran_input" name="lampiran_npwp" data-allowtypes="doc|DOC|pdf|PDF|docx|DOCX|jpg|JPG|jpeg|JPEG|png|PNG" style="display: none;" placeholder="Lampiran NWPW" data-old="<?php echo (!empty($l_npwp['id'])) ? $l_npwp['id'] : null; ?>">
				...
				<div class="col-sm-12 no-padding">
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-2" style="margin-left: 11px; padding-right: 20px;">
							<input class="form-control" type="text" name="nama_coretax_plg" placeholder="Nama Coretax" value="<?php echo $data['nama_coretax']; ?>">
						</div>
					</div>
				</div>
				<div class="col-sm-12 no-padding">
						...
						<tbody>
							...
							<?php else: ?>
								<tr class="detail_rekening v-center">
									...
									<td>
										<label class="text-right" data-idnama="<?php echo $list_lampiran_rekening_pelanggan['id'] ?>">
											<input type="file" onchange="showNameFile(this)" class="file_lampiran bank_pelanggan" name="lampiran_ddp[]" data-allowtypes="doc|DOC|pdf|PDF|docx|DOCX|jpg|JPG|jpeg|JPEG|png|PNG" style="display: none;" placeholder="Lampiran Rekening">
											<i class="glyphicon glyphicon-paperclip cursor-p" title="Lampiran Rekening"></i>
										</label>
									</td>
									<td>
