			...
			<div id="jenis_pelanggan">
				<div class="col-sm-4">
					...
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-6">
							<input class="form-control" type="text" name="jenis_plg" value="<?php echo $data['d_jenis']['nama']; ?>" readonly>
						</div>
					</div>
					<div class="form-group align-items-center d-flex">
				...
				<div class="col-sm-4">
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-6">
							<input required="required" class="form-control text-right" type="text" name="plafon" placeholder="Plafon" data-tipe="integer" value="<?php echo angkaRibuan($data['plafon']); ?>" readonly>
						</div>
					</div>
					<div class="form-group align-items-center d-flex">
