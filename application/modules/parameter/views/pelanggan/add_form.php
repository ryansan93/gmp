			...
			<div id="jenis_pelanggan">
				...
				<div class="col-sm-12">
					...
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-6">
							<input required="required" class="form-control nama_singkat_plg" type="text" placeholder="Nama (tanpa PT/CV/Tbk)">
						</div>
					</div>
					<div class="form-group align-items-center d-flex">
						<span class="col-sm-2 text-right">Nama Perusahaan</span>
						<div class="col-sm-8">
							<input required="required" class="form-control nama_perusahaan_plg" type="text" name="nama_plg" placeholder="Nama Perusahaan" readonly>
						</div>
					</div>
				</div>
				<div class="col-sm-12">
				...
				<div class="col-sm-12 no-padding">
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-2" style="margin-left: 11px; padding-right: 20px;">
							<input required="required" class="form-control ktp_input" type="text" name="ktp_plg" placeholder="Nomer KTP" />
						</div>
			...
			<div id="alamat_usaha_pelanggan">
				...
				<div class="col-sm-12 no-padding">
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-2" style="margin-left: 11px; padding-right: 20px;">
							<input class="form-control npwp_input" type="text" name="npwp_plg" placeholder="Nomer NPWP" />
						</div>
						<div class="col-sm-8 no-padding">
							<label class="col-sm-1" data-idnama="<?php echo $list_lampiran_usaha_pelanggan['id'] ?>">
								<input type="file" onchange="showNameFile(this)" class="file_lampiran pelanggan npwp_lampiran_input" name="lampiran_npwp" data-allowtypes="doc|DOC|pdf|PDF|docx|DOCX|jpg|JPG|jpeg|JPEG|png|PNG" style="display: none;" placeholder="Lampiran NWPW" />
				...
				<div class="col-sm-12 no-padding">
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-2" style="margin-left: 11px; padding-right: 20px;">
							<input class="form-control" type="text" name="nama_coretax_plg" placeholder="Nama Coretax" />
						</div>
					</div>
				</div>
				<div class="col-sm-12 no-padding">
