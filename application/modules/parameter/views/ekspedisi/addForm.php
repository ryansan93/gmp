			...
			<div id="jenis_ekspedisi">
				...
				<div class="col-sm-12">
					...
					<div class="form-group align-items-center d-flex">
						...
						<div class="col-sm-6">
							<input required="required" class="form-control nama_singkat_ekspedisi" type="text" placeholder="Nama (tanpa PT/CV/Tbk)">
						</div>
					</div>
					<div class="form-group align-items-center d-flex">
						<span class="col-sm-2 text-right">Nama Perusahaan</span>
						<div class="col-sm-8">
							<input required="required" class="form-control nama_perusahaan_ekspedisi" type="text" name="nama_ekspedisi" placeholder="Nama Perusahaan" readonly>
						</div>
					</div>
				</div>
				<div class="col-sm-12">
