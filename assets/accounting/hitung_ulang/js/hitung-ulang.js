var hu = {
	...
	hitungUlang: function () {
		...
		bootbox.confirm('Apakah anda yakin ingin melakukan hitung ulang data <b>'+jenis+'</b> bulan <b>'+nama_bulan+' '+tahun+'</b> ?', function (result) {
			if ( result ) {
				var params = {
				...
				$.ajax({
					url : 'accounting/HitungUlang/hitungUlang',
					data : {
						'params' : params
					},
					dataType : 'json',
					type : 'post',
					beforeSend : function(){ showLoading('Proses hitung ulang . . .'); },
