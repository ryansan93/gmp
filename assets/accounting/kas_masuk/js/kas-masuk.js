var km = {
    ...
    loadForm: function(v_id = null, resubmit = null) {
        ...
        $.ajax({
            url : 'accounting/KasMasuk/loadForm',
            data : {
                'id' :  v_id,
                'resubmit' : resubmit
            },
    ...
    cekData: function() {
		...
		if ( err > 0 ) {
                ...
                if ( !empty(no_faktur) ) {
                    ...
                    if ( tanggal < tgl_faktur ) {
                        if ( empty( keterangan_error ) ) {
                            keterangan_error = 'Tanggal kas masuk lebih kecil dari tanggal faktur, cek kembali data yang anda masukkan.';
                        } else {
                            keterangan_error += '<br><br>Tanggal kas masuk lebih kecil dari tanggal faktur, cek kembali data yang anda masukkan.';
                        }
            ...
            if ( !empty(keterangan_error) ) {
                ...
                return_keterangan_error += '<br><br>Apakah anda yakin ingin tetap menyimpan data kas masuk ?';
            } else {
                return_keterangan_error = 'Apakah anda yakin ingin menyimpan data kas masuk ?';
            }
        }
    ...
    delete: function(elm) {
        ...
        bootbox.confirm('Apakah anda yakin ingin meng-hapus data ?', function(result) {
            if ( result ) {
                ...
                $.ajax({
                    url: 'accounting/KasMasuk/delete',
                    dataType: 'json',
                    type: 'post',
                    data: {
                        'params': params
    ...
    printPreview: function (elm) {
        ...
        window.open('accounting/KasMasuk/printPreview/'+no_so, 'blank');
    }, // end - printPreview
    ...
    exportPdf : function (elm) {
        ...
        $.ajax({
            url: 'accounting/KasMasuk/exportPdf',
            dataType: 'json',
            type: 'post',
            data: {
                'params': params
