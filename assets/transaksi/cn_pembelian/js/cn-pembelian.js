var cn = {
	...
	setSelect2Gudang: function(elm) {
        $(elm).select2({
            ajax: {
                // delay: 500,
                // quietMillis: 150,
                url: 'transaksi/CnPembelian/getGudang',
                dataType: 'json',
                type: 'GET',
	...
	setSelect2NoSj: function(elm) {
        $(elm).select2({
            ajax: {
                // delay: 500,
                // quietMillis: 150,
                url: 'transaksi/CnPembelian/getNoSj',
                dataType: 'json',
                type: 'GET',
                data: function (params, jenis) {
                    var query = {
	...
	setSelect2Barang: function(elm) {
        $(elm).select2({
            ajax: {
                // delay: 500,
                // quietMillis: 150,
                url: 'transaksi/CnPembelian/getBarang',
                dataType: 'json',
                type: 'GET',
                data: function (params, jenis) {
                    var query = {
	...
	setSelect2DetJurnalTrans: function(elm) {
        $(elm).select2({
            ajax: {
                // delay: 500,
                // quietMillis: 150,
                url: 'transaksi/CnPembelian/getDetJurnalTrans',
                dataType: 'json',
                type: 'GET',
                data: function (params, jenis) {
                    var query = {
    ...
    getLists: function() {
        ...
        if ( err > 0 ) {
            ...
            $.ajax({
                url: 'transaksi/CnPembelian/getLists',
                data: { 'params': params },
                type: 'GET',
                dataType: 'HTML',
	...
	loadForm: function(id, edit, href) {
		...
		$.ajax({
            url: 'transaksi/CnPembelian/loadForm',
            data: { 'params': params },
            type: 'GET',
            dataType: 'HTML',
		...
		if ( err > 0 ) {
			...
			bootbox.confirm('Apakah anda yakin ingin menyimpan data ?', function (result) {
				if ( result ) {
					...
					$.ajax({
			            url: 'transaksi/CnPembelian/save',
			            data: { 'params': params },
			            type: 'POST',
			            dataType: 'JSON',
			            beforeSend: function(){ showLoading() },
		...
		if ( err > 0 ) {
			...
			bootbox.confirm('Apakah anda yakin ingin meng-ubah data ?', function (result) {
				if ( result ) {
					...
					$.ajax({
			            url: 'transaksi/CnPembelian/edit',
			            data: { 'params': params },
			            type: 'POST',
			            dataType: 'JSON',
			            beforeSend: function(){ showLoading() },
	...
	delete: function(elm) {
		...
		bootbox.confirm('Apakah anda yakin ingin meng-hapus data ?', function (result) {
			if ( result ) {
				...
				$.ajax({
					url: 'transaksi/CnPembelian/delete',
					data: { 'params': params },
					type: 'POST',
					dataType: 'JSON',
					beforeSend: function(){ showLoading() },
