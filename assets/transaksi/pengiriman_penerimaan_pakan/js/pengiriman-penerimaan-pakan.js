...
var pp = {
    ...
    load_form: function(v_id = null, v_resubmit = null) {
        ...
        $.ajax({
            url : 'transaksi/PengirimanPenerimaanPakan/load_form',
            data : {
                'id' :  v_id,
                'resubmit': v_resubmit
            },
    ...
    get_op_not_kirim: function(elm) {
    	...
    	if ( empty(unit) || empty(tgl_kirim) ) {
    		...
    		$.ajax({
				url: 'transaksi/PengirimanPenerimaanPakan/get_op_not_kirim',
				data: {
					'params': params
				},
				type: 'POST',
	...
	get_list_table: function(no_order = null) {
		...
		$.ajax({
			url: 'transaksi/PengirimanPenerimaanPakan/get_list_table',
			data: {
	...
	exec_save_kirim_pakan: function(params = null) {
		...
		$.ajax({
			url: 'transaksi/PengirimanPenerimaanPakan/save',
			data: {
				'params': params
			},
			type: 'POST',
	...
	exec_edit_kirim_pakan: function(params = null) {
		...
		$.ajax({
			url: 'transaksi/PengirimanPenerimaanPakan/edit',
			data: {
				'params': params
			},
			type: 'POST',
	...
	cek_stok_gudang: function(elm) {
		...
		if ( jenis_kirim == 'opkg' ) {
			...
			$.ajax({
				url: 'transaksi/PengirimanPenerimaanPakan/cek_stok_gudang',
				data: {
					'params': params
				},
				type: 'POST',
	...
	listActivity: function(elm) {
        ...
        $.get('transaksi/PengirimanPenerimaanPakan/listActivity',{
                'params': params
            },function(data){
            var _options = {
                className : 'veryWidth',
	...
	getSjAsal: function(elm) {
		...
		if ( !empty(noreg) ) {
			...
			$.ajax({
				url: 'transaksi/PengirimanPenerimaanPakan/getSjAsal',
				data: {
					'params': params
				},
				type: 'POST',
