var dn = {
	...
	setSelect2NoSj: function(elm) {
        $(elm).select2({
            ajax: {
                // delay: 500,
                // quietMillis: 150,
                url: 'transaksi/DnPenjualan/getNoSj',
                dataType: 'json',
                type: 'GET',
	...
	setSelect2Barang: function(elm) {
        $(elm).select2({
            ajax: {
                // delay: 500,
                // quietMillis: 150,
                url: 'transaksi/DnPenjualan/getBarang',
                dataType: 'json',
                type: 'GET',
                data: function (params, jenis) {
                    var query = {
	...
	setSelect2DetJurnalTrans: function(elm) {
        $(elm).select2({
            ajax: {
                // delay: 500,
                // quietMillis: 150,
                url: 'transaksi/DnPenjualan/getDetJurnalTrans',
                dataType: 'json',
                type: 'GET',
                data: function (params, jenis) {
                    var query = {
    ...
    getLists: function() {
        ...
        if ( err > 0 ) {
            ...
            $.ajax({
                url: 'transaksi/DnPenjualan/getLists',
                data: { 'params': params },
                type: 'GET',
                dataType: 'HTML',
	...
	loadForm: function(id, edit, href) {
		...
		$.ajax({
            url: 'transaksi/DnPenjualan/loadForm',
            data: { 'params': params },
            type: 'GET',
            dataType: 'HTML',
		...
		if ( err > 0 ) {
			...
			bootbox.confirm('Apakah anda yakin ingin menyimpan data ?', function (result) {
				if ( result ) {
					...
					$.ajax({
			            url: 'transaksi/DnPenjualan/save',
			            data: { 'params': params },
			            type: 'POST',
			            dataType: 'JSON',
			            beforeSend: function(){ showLoading() },
		...
		if ( err > 0 ) {
			...
			bootbox.confirm('Apakah anda yakin ingin meng-ubah data ?', function (result) {
				if ( result ) {
					...
					$.ajax({
			            url: 'transaksi/DnPenjualan/edit',
			            data: { 'params': params },
			            type: 'POST',
			            dataType: 'JSON',
			            beforeSend: function(){ showLoading() },
	...
	delete: function(elm) {
		...
		bootbox.confirm('Apakah anda yakin ingin meng-hapus data ?', function (result) {
			if ( result ) {
				...
				$.ajax({
					url: 'transaksi/DnPenjualan/delete',
					data: { 'params': params },
					type: 'POST',
					dataType: 'JSON',
					beforeSend: function(){ showLoading() },
