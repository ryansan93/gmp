var cn = {
	...
	setSelect2DetJurnalTrans: function(elm) {
        $(elm).select2({
            ajax: {
                // delay: 500,
                // quietMillis: 150,
                url: 'transaksi/CnPakan/getDetJurnalTrans',
                dataType: 'json',
                type: 'GET',
                data: function (params, jenis) {
                    var query = {
    ...
    getLists: function() {
        ...
        if ( err > 0 ) {
            ...
            $.ajax({
                url: 'transaksi/CnPakan/getLists',
                data: { 'params': params },
                type: 'GET',
                dataType: 'HTML',
	...
	loadForm: function(id, edit, href) {
		...
		$.ajax({
            url: 'transaksi/CnPakan/loadForm',
            data: { 'params': params },
            type: 'GET',
            dataType: 'HTML',
