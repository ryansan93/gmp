/* ============================================================================
   ...
   `docs/alter_hitung_stok_siklus_adjout_voadip_siklus.sql` diterapkan
   (2026-09-04). Diambil via OBJECT_DEFINITION() langsung dari server live
   sebelum ALTER PROCEDURE dijalankan.

   ROLLBACK: kalau patch adjout_voadip_siklus perlu dibatalkan, jalankan isi
   file ini apa adanya (ganti CREATE jadi ALTER kalau prosedurnya masih ada,
   atau CREATE langsung kalau sudah ke-drop) ke gmp_erp_live.
   ============================================================================ */
